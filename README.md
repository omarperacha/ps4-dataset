...
This repository contains the data itself, pretrained AI model weights, methods to validate and add new samples to the dataset, and a toolkit for developing and evaluating state-of-the-art secondary structure prediction models.
